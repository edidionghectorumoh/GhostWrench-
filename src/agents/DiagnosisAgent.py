"""
Multimodal Diagnosis Agent using Amazon Nova 2 Lite.
...
from config import bedrock_runtime, NOVA_2_LITE_MODEL_ID
...
class DiagnosisAgent:
    ...
    def __init__(
        ...
        self.model_id = NOVA_2_LITE_MODEL_ID
        self.rag_system = rag_system
        
        logger.info(
            f"Diagnosis Agent initialized with Nova 2 Lite "
    ...
    def _call_nova_pro(
        ...
        """
        Call Amazon Nova 2 Lite for multimodal analysis via Bedrock Converse API.
        ...
        try:
            ...
            # Add image if provided (Converse API accepts raw bytes directly)
            if image_data:
                content.append({
                    "image": {
                        "format": "jpeg",
            ...
            # Call Nova 2 Lite via Converse API with Extended Thinking
            ...
            raise RuntimeError(f"Failed to call Nova 2 Lite: {e}")
