...
This module implements a cloud-based judge that uses Amazon Nova Pro and 
...
from config import bedrock_runtime, NOVA_PRO_MODEL_ID, CLAUDE_SONNET_MODEL_ID
...
class CloudJudge:
    ...
    def __init__(
        ...
        self.nova_model_id = NOVA_PRO_MODEL_ID
    ...
    def _call_nova(
        ...
        try:
            ...
            logger.error(f"Nova API call failed: {e}")
            raise RuntimeError(f"Failed to call Nova via Bedrock: {e}")
